...
if __name__ == '__main__':
    ...
    # m2 = np.load('m2.npy')
    # m = m1+m2
    # # img = np.load(os.path.join('F:\IDM\Pycharm\lungcancercode\preprocessing','subset0.npy'))
    # img = np.load(os.path.join('F:\IDM\Pycharm\lungcancercode\preprocessing','subset0.npy'))
    # img = m.astype(int)*img
    #
    #
    # img = lumTrans(img)
    # bone_thresh = 210
    # pad_value = 170
    # bones = img > bone_thresh
    # img[bones] = pad_value
    # np.save('lungSeg',img)
